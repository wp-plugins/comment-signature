...
/*
  ...
  Tags: comment signature, user signature, signature, signature comment 
  Version: 2.2
  Author: vinoth06
...
function buffecode_comment_sign_edit_show_profile($user) {
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                <textarea name="buffercode_cmt_sign_textarea" class="regular-text" maxlength="<?php echo get_option('comment_signature_setting_sig_char'); ?>"><?php echo esc_attr(get_the_author_meta('buffercode_cmt_sign_textarea', $user->ID)); ?> </textarea><br>
                <span class="description">Please enter your Signature. [Max - <?php echo get_option('comment_signature_setting_sig_char', 50); ?> Characters]</span><br>
            </td>
        </tr>
...
function comment_signature_register_settings() {
    ...
    register_setting('comment_signature_setting_group', 'comment_signature_setting_sig_char');
    ...
    <div class="wrap">
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    <th scope="row">Maximum Number of Signature Characters</th>
                    <td><input type="number" name="comment_signature_setting_sig_char" value="<?php echo get_option('comment_signature_setting_sig_char'); ?>" />px</td>
                </tr>
