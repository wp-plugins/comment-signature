...
function buffecode_comment_sign_cmt_text( $buffercode_cmt_sign_cmt_text) {
	global $comment;
	$buffercode_cmt_sign_cmt_text.='<!-- Buffercode.com Comment Signature --><br><br><hr width="90%"><code>';
	...
	$buffercode_cmt_sign_cmt_text.='</code><!-- Buffercode.com Comment Signature -->';
